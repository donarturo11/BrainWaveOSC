...
!define APPNAME "BrainWaveOSC"
!define COMPANYNAME "donarturo11"
!define DESCRIPTION "A simple software to training tuning systems"
...
Icon "${APPNAME}\icon.ico"
outFile "${APPNAME}-win-installer.exe"
